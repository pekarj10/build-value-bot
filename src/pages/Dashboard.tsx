...
import { Plus, FolderOpen, LayoutList, HelpCircle, MessageSquare, DollarSign } from 'lucide-react';
      ...
      <div className="p-8 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Link to="/project/new">
              <Card className="p-5 hover:border-primary/30 transition-base cursor-pointer group h-full">
