...
import { AlertTriangle, TrendingUp, TrendingDown, Eye, BadgeCheck } from 'lucide-react';
...
const quickFilters = [
  ...
  {
    id: 'verified',
    label: 'Verified Actuals',
    icon: BadgeCheck,
    description: 'Items with verified actual costs from quotes/invoices',
  },
];
